...
public class booking
{
	...
	public void bookTest() throws InterruptedException
	{
		...
		// WebDriver driver = BrowserFactory.startBrowser(Constants.FIREFOX);
		// String
		...
		//
		// bookPage1.
		// adultDetails(String firstname,String lastname,String phone, int
		// noAdult, int child, int infant)
		// bookPage1.adultDetails(("shivam", lastname, phone, noAdult, child,
		// infant);
